...
3. **Pick the “one sentence” identity statement** (this becomes the hero `H1`)
...
4. **What’s the #1 proof you want to lead with on the homepage?**
...
9. **Color palette (emerald-leaning; pick one “direction”, not exact hex yet)**
...
10. **Material 3 influence (subtle)**

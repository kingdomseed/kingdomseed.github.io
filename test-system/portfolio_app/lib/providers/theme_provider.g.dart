...
/// Theme mode provider for dark/light mode toggle
final class ThemeModeProvider extends $NotifierProvider<ThemeMode, bool> {
  /// Theme mode provider for dark/light mode toggle
...
String _$themeModeHash() => r'0e5b1d2ffcfea7c3f8de88b3a0982cc434cc95cb';

/// Theme mode provider for dark/light mode toggle

abstract class _$ThemeMode extends $Notifier<bool> {
  bool build();
  @$mustCallSuper
  @override
  void runBuild() {
